        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/sportsbooks" className="text-sm text-zinc-400 hover:text-emerald-400">Sportsbook Reviews</Link></li>
              <li><Link href="/guides" className="text-sm text-zinc-400 hover:text-emerald-400">Odds Calculator</Link></li>
              <li><Link href="/guides" className="text-sm text-zinc-400 hover:text-emerald-400">Betting Glossary</Link></li>
            </ul>
          </div>
